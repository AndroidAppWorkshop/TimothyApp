...
/**
 * Created by h94u04 on 2015/6/11.
 */
public class StringResources {
    public static class Index {
        public static int ActivityResult = 5 ;
    }
    public static class Key {
        public static String ApiKey = "Authorization";
        public static String BackStack = "BackStack";

        public static String ContentType = "Content-Type";
        public static String Data = "Data";
        public static String HeaderFormat = "application/json; charset=utf-8";
    ...
    {
        public static String Undone = "¥¼®Ö¾P";
        public static String Done = "¤w®Ö¾P";
    }
